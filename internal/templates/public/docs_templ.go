		...
		if !(strings.Contains(page.Path, "index.md") && page.Order != 1) {
			if len(page.Children) == 0 {
				...
				if isChild {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/public/docs.templ`, Line: 37, Col: 78}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/public/docs.templ`, Line: 39, Col: 19}
					}
		...
		if len(page.Headings) > 2 {
			...
			for _, item := range page.Headings {
				if item.Level < 3 {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/public/docs.templ`, Line: 89, Col: 64}
					}
