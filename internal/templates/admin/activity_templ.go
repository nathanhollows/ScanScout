			...
			for i, location := range user.CurrentInstance.Locations {
				...
				if user.CurrentInstance.Settings.CompletionMethod == models.CheckInAndOut {
					...
					if location.AvgDuration > 0 {
						...
						templ_7745c5c3_Var12, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprint(location.AvgDuration))
						if templ_7745c5c3_Err != nil {
	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if len(team.Scans) > 0 {
			...
			for _, scan := range team.Scans {
				...
				templ_7745c5c3_Var28, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprint(scan.CreatedAt))
				if templ_7745c5c3_Err != nil {
