...
// Takenn from
// https://github.com/yuin/goldmark/blob/15ade8aace9a9f269846fb83d36fc7bcec875cd5/extension/tasklist.go
// Commit: 04d4dd5
// Changes:
// - Removed the `disabled` attribute from the checkbox input element
